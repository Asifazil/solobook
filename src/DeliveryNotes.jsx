        ...
        <Card sx={{ mt: 2 }}>
          <CardContent>
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6} md={4}><PartySelect options={parties} value={selectedParty} onChange={(v) => setSelectedParty(v)} label="Customer" placeholder="Search customer…" /></Grid>
